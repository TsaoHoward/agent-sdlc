...
async function main() {
  ...
  const verificationMetadata = {
    ...
    proposal_ref: traceability.proposal_ref || null,
    ...
    workflow_ref: process.env.GITHUB_WORKFLOW || process.env.GITEA_WORKFLOW || "target-docs-ci",
    ...
    ci_run_ref:
      ...
      null,
    ci_run_url: buildCiRunUrl(),
    event_name: process.env.GITHUB_EVENT_NAME || process.env.GITEA_EVENT_NAME || null,
    event_payload_path: process.env.GITHUB_EVENT_PATH || process.env.GITEA_EVENT_PATH || null,
    ci_status: "pending",
  };

  writeJson(path.join(outputDir, "verification-metadata.json"), verificationMetadata);
