...
|---|---|---|---|---|---|
| I-001 | Phase 1 Minimum Closed Loop Implementation Packaging | In Progress | `docs/roadmap.md` Phase 1; WBS `3`, `3.1`-`3.6` | Investigate why fresh local Gitea PRs are not auto-creating actions runs, then carry the remaining traceability path from CI-linked reviewer surfaces into explicit review-outcome linkage | Archive after the first slice is underway and the remaining work is split or absorbed into active execution tracking |
